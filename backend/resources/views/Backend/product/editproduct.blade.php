...
<?php include(app_path().'/Helpers/function.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    @include('Backend.partials.content-header', ['name' => 'Edit product', 'key'=>'Edit'])
        ...
        <div class="row">
          <div class="col-md-6">
            <form action="{{route('product.update',['id'=>$product->id])}}", method="POST" enctype="multipart/form-data">
              ...
              <button  onclick="return confirm('Bạn có chắc chắn muốn thay đổi thông tin sản phẩm này?');" type="submit" class="btn btn-primary">Submit</button>
